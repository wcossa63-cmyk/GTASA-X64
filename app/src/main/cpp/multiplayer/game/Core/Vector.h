...
public:
    ...
    */
    ...
    static CVector x_axis;
    static CVector y_axis;
    static CVector z_axis;

    static auto XAxisVector() { return &x_axis; }
    static auto YAxisVector() { return &y_axis; }
    static auto ZAxisVector() { return &z_axis; }
...
inline CVector CVector::x_axis{1.0f, 0.0f, 0.0f};
inline CVector CVector::y_axis{0.0f, 1.0f, 0.0f};
inline CVector CVector::z_axis{0.0f, 0.0f, 1.0f};