...
static void (*CStreaming_Init2)();

static void CStreaming_Init2_hook() {
    CFileLoader::LoadPedModels();
    CStreaming_Init2();
}
...
void CStreaming::InjectHooks() {
    ...
    CHook::InlineHook("_ZN10CStreaming5Init2Ev", &CStreaming_Init2_hook, &CStreaming_Init2);
}
