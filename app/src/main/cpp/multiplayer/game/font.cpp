...
void CFont::AsciiToGxtChar(const char* ascii, uint16_t* gxt) {
    CHook::CallFunction<void>("_Z14AsciiToGxtCharPKcPt", ascii, gxt);
}

void CFont::SetScale(float fHeight) {
    CHook::CallFunction<void>("_ZN5CFont8SetScaleEf", fHeight);
}
...
void CFont::SetColor(CRGBA dwColor) {
    return CHook::CallFunction<void>("_ZN5CFont8SetColorE5CRGBA", dwColor);
}
