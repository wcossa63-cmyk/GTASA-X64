...
{
    LOGRPC("ScrForceSpawnSelection");
    CLocalPlayer::ReturnToClassSelection();
}
...
void ScrSetPlayerPos(RPCParameters *rpcParams)
{
    ...
    // просто телепорт, без повторного Spawn / RPC_Spawn
...
void ScrSetSpawnInfo(RPCParameters *rpcParams)
{
    ...
    if (!rpcParams || rpcParams->numberOfBitsOfData < sizeof(PLAYER_SPAWN_INFO) * 8)
    {
        Log("RPC ScrSetSpawnInfo: invalid payload size %d bits",
